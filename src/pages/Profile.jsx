...
<main
  className={`${isUnauthenticatedVisitor ? "w-full md:w-[60%]" : "profile-main flex-1"} min-h-screen profile_max_width overflow-y-auto py-8 mx-auto box-border overflow-x-hidden`}
            >
              {alert.show && (
                <CustomAlert

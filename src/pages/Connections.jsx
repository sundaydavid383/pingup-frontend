  ...
  return (
    <div className="w-full min-h-screen overflow-y-auto bg-slate-50 flex">
      <div className="max-w-6xl mx-auto p-6 animate-fadeIn">
        ...
        shadow rounded-xl p-3 sm:p-4 transition-all duration-200 cursor-pointer
      ...
      `}
                    >
                      <item.icon
                        className={`w-6 h-6 mb-1 shrink-0 transition-colors
          ${isActive ? "text-[var(--secondary)]" : "text-[var(--text-secondary)] group-hover:text-[var(--secondary)]"}
        `}
                      />

                      <b className="text-lg sm:text-2xl md:text-3xl">
                        {item.value?.length || 0}
                      </b>

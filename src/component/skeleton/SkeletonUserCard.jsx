...
export default function SkeletonUserCard() {
  return (
    <div className="p-5 w-full shadow-md border border-gray-200 rounded-xl bg-white animate-pulse flex flex-col justify-between min-h-[240px] md:min-h-[260px] overflow-hidden">

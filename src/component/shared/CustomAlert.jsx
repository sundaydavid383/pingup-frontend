...
const CustomAlert = ({
  ...
  const bgColors = {
    success:
      "bg-gradient-to-br from-emerald-600 to-emerald-700 border-emerald-400/50",
    error:
      "bg-gradient-to-br from-red-600 to-red-700 border-red-400/50",
    warning:
      "bg-gradient-to-br from-amber-600 to-amber-700 border-amber-400/50",
    info:
  ...
  const alertContent = (
    ...
    >
      ...
      >
        <div
          className={`mt-0.5 flex-shrink-0 transition-transform duration-700 ${
